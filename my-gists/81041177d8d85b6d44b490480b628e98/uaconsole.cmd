...
for /l %%a in ( 0, 1, 25 ) do (
  ...
  call set "_LSTRING=%%_LSTRING:!_UPCASE!=!_LWCASE!%%"
  call set "_USTRING=%%_USTRING:!_LWCASE!=!_UPCASE!%%"

  call set "command=%%command:!_LWCASE!=!_UPCASE!%%"
  call set "params_1=%%params_1:!_LWCASE!=!_UPCASE!%%"
)
...
if "%command%" == "%%c"  if "%params_1%" == " /?"  (
  set "params=%params% && echo. && pause"
)
...
for %%d in ( --help -h ) do ^
if "%command%" == "%%c"  if "%params_1%" == " %%d"  (
  call set "params=%params% && echo. && pause"
)
