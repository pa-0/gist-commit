...
# When you fork a gist, all comments posted under the original are not copied over.
# The instructions to the original gist of this fork are in the comments
# If you fork the original gist, you lose the supplemental instructions.
# I've added them to the gist itself as a second file so that they travel together.
