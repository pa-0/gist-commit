...
!macro _UnRegister::DLL _DLL _FSR _ERR1 _ERR2
	...
	Pop ${_ERR2}
!macroend
!define BackupLocalGUID "!insertmacro _BackupLocalGUID"
!macro _BackupLocalGUID _GUID _FSR _SECTION _KEY
	ClearErrors
	ReadRegStr $0 HKLM `SOFTWARE\Classes\CLSID\${_GUID}\InprocServer32` ""
	${IfNot} ${Errors}
		StrCmp ${_FSR} /DISABLEFSR 0 +4
	...
	${EndIf}
!macroend
!define RestoreLocalGUID "!insertmacro _RestoreLocalGUID"
!macro _RestoreLocalGUID _FSR _SECTION _KEY
	ClearErrors
...
${SegmentPre}
;=# Register DLLs
	${BackupLocalGUID} `${GUID}` "" "" DLL ;=  Uninstall Local DLL
;=# Services
	ClearErrors
...
${SegmentPrePrimary}
;=# Register DLLs
	${Register::DLL} `${DLL}` /DISABLEFSR $0 $1
;=# Services
...
${SegmentPostPrimary}
;=# Registry DLLs
	${UnRegister::DLL} `${DLL}` /DISABLEFSR $0 $1
;=# Services
	${Service::Stop} ${SVC} /DISABLEFSR $0 $1
	Sleep 50
	${Service::Remove} ${SVC} /DISABLEFSR $0 $1
