...
$teamv                           = New-Object system.Windows.Forms.Button
$teamv.text                      = "Teamviewer Host"
$teamv.width                     = 212
$teamv.height                    = 30
$teamv.location                  = New-Object System.Drawing.Point(4,426)
$teamv.Font                      = New-Object System.Drawing.Font('Microsoft Sans Serif',12)
...
$Panel1.controls.AddRange(@($teamv,$firefox,$7zip,$sharex,$adobereader,$notepad,$gchrome,$mpc,$vlc,$powertoys,$winterminal,$vscode,$Label2,$everythingsearch,$sumatrapdf,$vscodium,$imageglass,$gimp,$Label7,$Label8,$Label9,$advancedipscanner,$putty,$etcher,$translucenttb,$githubdesktop,$discord,$autohotkey))
...
$teamv.Add_Click({
    ...
    $ResultText.text = "`r`n" +"`r`n" + "Installing Teamviewer Host... Please Wait" 
    winget install -e --id TeamViewer.TeamViewer.Host | Out-Host
    if($?) { Write-Host "Installed Teamviewer Host" }
    $ResultText.text = "`r`n" + "Finished Installing Teamviewer Host" + "`r`n" + "`r`n" + "Ready for Next Task"
})
