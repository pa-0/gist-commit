        ...
        foreach($proc in $Process)
        {
            if($proc.Id -ne 0 -and $proc.Id -ne 4 -and $proc.Id -ne $PID)
            {
                ...
                try
                {
                    ...
                    $PrimaryTokenGroup = GetTokenInformation -TokenInformationClass TokenGroups -TokenHandle $hToken
                    ...
                    $PrimaryTokenPrivileges = (GetTokenInformation -TokenInformationClass TokenPrivileges -TokenHandle $hToken | Where-Object {$_.Attributes -like "*ENABLED*"} | select -ExpandProperty Privilege) -join ";"
                    ...
                    $obj | Add-Member -MemberType NoteProperty -Name ProcessGuid -Value $ProcessGuid
                    ...
                    $obj | Add-Member -MemberType NoteProperty -Name UserSid -Value $PrimaryTokenUser.Sid
                    $obj | Add-Member -MemberType NoteProperty -Name UserName -Value $PrimaryTokenUser.Name
                    $obj | Add-Member -MemberType NoteProperty -Name OwnerSid -Value $PrimaryTokenOwner.Sid
                    $obj | Add-Member -MemberType NoteProperty -Name OwnerName -Value $PrimaryTokenOwner.Name
                    #$obj | Add-Member -MemberType NoteProperty -Name Groups -Value $PrimaryTokenGroup
                    $obj | Add-Member -MemberType NoteProperty -Name IntegrityLevel -Value $PrimaryTokenIntegrityLevel
                    $obj | Add-Member -MemberType NoteProperty -Name Type -Value $PrimaryTokenType
                    $obj | Add-Member -MemberType NoteProperty -Name ImpersonationLevel -Value 'None'
                    $obj | Add-Member -MemberType NoteProperty -Name SessionId -Value $PrimaryTokenSessionId
                    $obj | Add-Member -MemberType NoteProperty -Name Origin -Value $PrimaryTokenOrigin
                    $obj | Add-Member -MemberType NoteProperty -Name Privileges -Value $PrimaryTokenPrivileges
                    $obj | Add-Member -MemberType NoteProperty -Name IsElevated -Value $PrimaryTokenElevation
                    $obj | Add-Member -MemberType NoteProperty -Name ElevationType -Value $PrimaryTokenElevationType
                    #$obj | Add-Member -MemberType NoteProperty -Name AccessInformation -Value $PrimaryTokenAccessInformation
                    $obj | Add-Member -MemberType NoteProperty -Name PrimaryUserSid -Value  $PrimaryTokenUser.Sid.ToString()
                    $obj | Add-Member -MemberType NoteProperty -Name PrimaryUserName -Value $PrimaryTokenUser.Name.Value
                    $obj | Add-Member -MemberType NoteProperty -Name PrimaryIntegrityLevel -Value $PrimaryTokenIntegrityLevel.ToString()
                    $obj | Add-Member -MemberType NoteProperty -Name PrimaryType -Value $PrimaryTokenType.ToString()
                    $obj | Add-Member -MemberType NoteProperty -Name PrimaryImpersonationLevel -Value 'None'
                    $obj | Add-Member -MemberType NoteProperty -Name PrimarySessionId -Value $PrimaryTokenSessionId
                ...
                foreach($thread in $proc.Threads)
                {
                    ...
                    try
                    {
                        $hToken = OpenThreadToken -ThreadHandle $hThread -DesiredAccess TOKEN_QUERY, TOKEN_QUERY_SOURCE
                        ...
                        $TokenAccessInformation = GetTokenInformation -TokenInformationClass TokenAccessInformation -TokenHandle $hToken
                        ...
                        #$obj | Add-Member -MemberType NoteProperty -Name Groups -Value $TokenGroup
                        ...
                        #$obj | Add-Member -MemberType NoteProperty -Name AccessInformation -Value $TokenAccessInformation
                        $obj | Add-Member -MemberType NoteProperty -Name PrimaryUserSid -Value  $PrimaryTokenUser.Sid.ToString()
                        $obj | Add-Member -MemberType NoteProperty -Name PrimaryUserName -Value $PrimaryTokenUser.Name.Value
                        $obj | Add-Member -MemberType NoteProperty -Name PrimaryIntegrityLevel -Value $PrimaryTokenIntegrityLevel.ToString()
                        $obj | Add-Member -MemberType NoteProperty -Name PrimaryType -Value $PrimaryTokenType.ToString()
